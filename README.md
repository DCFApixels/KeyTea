...
Список наборов символов редактируемый. Кнопка внизу списка со значком плюса добавляет новый пустой набор, кнопка в виде шестерни открывает экран редактирования набора символов.
